...
var intro = function intro() {
  ...
  tl.from({ el: '#burger-border-wrap', p: { opacity: [0, .6] }, d: 1500, e: 'ExpoOut', delay: 500 });
  tl.from({ el: '.burger-line-hover', p: { x: [105, 0] }, d: 1000, e: 'ExpoOut', delay: 750 });
  tl.from({ el: '#burger-mask', p: { y: [100, -100] }, d: 2000, e: 'ExpoOut', delay: 1000 });
...
Loader.pr.from({ el: ".loader-line", p: { y: [100, 100 * t] }, d: 4000, e: "Power4InOut" });
